    ...
    <>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 justify-items-center gap-4">
        ...
        >
          ...
          eaque beatae tenetur placeat. Iste repellendus fugit ducimus
          veritatis. Aperiam rerum unde voluptatum doloremque quis sapiente
          fugiat labore iure. Id?
        </Card>
        <Card
          title="John Doe"
          image="https://source.unsplash.com/random?wallpaper"
        ...
        >
          ...
          libero autem vitae ex voluptas, cumque fuga odit, eveniet blanditiis
          aut, quidem illum deserunt saepe incidunt ipsa beatae quibusdam
